...
library Ayo2x6 {
    ...
    function applyMove(uint256 board, uint256 move, uint8 turn) internal pure returns (uint256) {
    ...
    function isLegalMove(uint256 board, uint256 move, uint8 turn) internal pure returns (bool ret) {
